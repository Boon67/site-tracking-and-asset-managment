...
cycles=10; //Hack for running message queue clean up if more than 1000 messages
var _resp;
function _clearMessageQueues(req, resp){
   ...
   i=0;
    ...
    i=0;
    while (i<cycles)  {
        msg.getAndDeleteMessageHistory(MODBUSREQUESTTOPIC, MESSAGECOUNT, new Date().getTime() / 1000, null, null, callback);
        i++;
    }
